"""Legacy Open SDG validation script.

Use this when validating Open SDG-style data/metadata. The current public
Next.js dashboard build is validated separately with `npm run build`.
"""
